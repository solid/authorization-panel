...
- I want to use the "Acme" project-management App which is a Solid enabled
- I'm not logged in
- I do solid OIDC
...
- Acme project sends me to my authorisation agent and express the kind of data they need authorisation to (Project Management data for example) Then asks which projects? all/work...
