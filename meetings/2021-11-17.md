...
Frederick Gibson (Fred): I am the ceo of Graphmetrix. 
 ...
 Apps is a productivity app suite (similar to Zoho(?))
 We have a digital twin syste inside the pod service.
...
Fred: 
  The current system would not work with us. We move the agent check inside the loop.
  ...
  The problem is copying the data around.
Henry: Which issue are you talking about? Can you put link in our notes. 
https://github.com/solid/web-access-control-spec/issues/102
e Pavlik: Based on what do you apply inheritance? The URI / paths or ldp:contains statements.
Fred: ...
