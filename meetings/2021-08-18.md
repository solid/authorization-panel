...
In those cases a 401 with a link to the rules that enables a client to know what to present to gain access (eg proof of being over 18), is completely fine.
Indeed, there are many real-life use-cases where it is widely accepted that access control rules should be public: 
 * If you walk in the country side you may see a sign "Do not trespass" sign. 
