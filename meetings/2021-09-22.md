...
* **Sarven**: WAC is called basic access control ontology, it should be able to do a lot of stuff for you. There is long list of things the can also be done which it doesn't do - but it can via extensions.. or updating the spec.
...
* **Matthieu**: wondering about UCs and think Henry is right.. Write on. !!something missing here 
