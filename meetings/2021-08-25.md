...
Barath: It is important to make sure the types of modes and agent classes is clear.
...
Henry: What `wac:AuthenticatedAgent` is especially important for, is that it shows us how 
...
We can thus create new classes using description Logic (OWL is a description logic) of sets of agents that have certain attributes, such as people under the age of 18. This is what will enable us to move towards attribute-based access control.
...
Henry: In the evaluation section we would need to take one of those use cases dealing with modes and show  how WAC, WAC+ and ACP ca
